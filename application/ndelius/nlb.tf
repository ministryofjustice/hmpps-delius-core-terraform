module "external_nlb" {
  ...
  eip_allocation_ids = [
    data.terraform_remote_state.persistent-eip.outputs.delius_ndelius_az1_lb_eip["allocation_id"],
    data.terraform_remote_state.persistent-eip.outputs.delius_ndelius_az2_lb_eip["allocation_id"],
    data.terraform_remote_state.persistent-eip.outputs.delius_ndelius_az3_lb_eip["allocation_id"],
  ]
  ...
  haproxy_security_groups = [
    ...
    data.terraform_remote_state.delius_core_security_groups.outputs.sg_pingdom_in_id,
