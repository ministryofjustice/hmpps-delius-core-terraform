...
data "template_file" "container_definition" {
  ...
  vars = {
    ...
    database_url          = data.terraform_remote_state.database.outputs.jdbc_failover_url
    ...
    ldap_base_users       = replace(local.ldap_config["base_users"], ",${local.ldap_config["base_root"]}", "")
    ldap_base_clients     = replace(local.ldap_config["base_service_users"], ",${local.ldap_config["base_root"]}", "")
    ldap_base_roles       = replace(local.ldap_config["base_roles"], ",${local.ldap_config["base_root"]}", "")
    ldap_base_role_groups = replace(local.ldap_config["base_role_groups"], ",${local.ldap_config["base_root"]}", "")
    ldap_base_groups      = replace(local.ldap_config["base_groups"], ",${local.ldap_config["base_root"]}", "")
