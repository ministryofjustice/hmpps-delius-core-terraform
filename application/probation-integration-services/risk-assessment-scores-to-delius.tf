module "risk-assessment-scores-to-delius" {
  ...
  service_name                   = "risk-assessment-scores-to-delius"
...
resource "aws_iam_role_policy_attachment" "risk-assessment-scores-to-delius" {
  role       = module.risk-assessment-scores-to-delius.exec_role.name
