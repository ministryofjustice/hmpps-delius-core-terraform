module "probation-offender-events" {
  ...
  service_name                   = "probation-offender-events"
...
resource "aws_iam_role_policy_attachment" "probation-offender-events" {
  role       = module.probation-offender-events.exec_role.name
