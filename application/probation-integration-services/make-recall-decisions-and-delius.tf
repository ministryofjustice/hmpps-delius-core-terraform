module "make-recall-decisions-and-delius" {
  ...
  service_name                   = "make-recall-decisions-and-delius"
...
resource "aws_iam_role_policy_attachment" "make-recall-decisions-and-delius" {
  role       = module.make-recall-decisions-and-delius.exec_role.name
