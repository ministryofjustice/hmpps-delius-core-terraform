module "custody-key-dates-and-delius" {
  ...
  service_name                   = "custody-key-dates-and-delius"
...
resource "aws_iam_role_policy_attachment" "custody-key-dates-and-delius" {
  role       = module.custody-key-dates-and-delius.exec_role.name
