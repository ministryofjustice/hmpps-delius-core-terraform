...
locals {
    ...
    engineering_account_prefix = lookup(zipmap(values(var.aws_engineering_account_ids), keys(var.aws_engineering_account_ids)), local.engineering_account_id, "non-prod") == "prod" ? "prod" : "dev"
